...
class OpenvswitchMechanismVHOSTVFIOTestCase(OpenvswitchMechanismBaseTestCase):
    ...
    @mock.patch('networking_vhost_vfio.neutron.ml2.driver.mech_ovs_vhost_vfio'
                '.OVSvHostVFIOMechanismDriver.get_vif_type')
    def _test_pre_get_vif_details(self, pb_vif_type, mock_get_vif_type):
        mock_type = "mock_mdev_type"
        mock_parent = "mock_parent_device"
        mock_id = "292daba0-1e2f-43a2-b8da-82826fb9c22f"

        self.driver.get_vif_type.return_value = pb_vif_type
    ...
    def test_pre_get_vif_details_vif_type_ovs(self):
        pb_vif_type = portbindings.VIF_TYPE_OVS
